...
const recipient = fs.readFileSync(".recipient").toString().trim();
const socketUrl = fs.readFileSync(".socket").toString().trim();
...
const provider = new ethers.providers.WebSocketProvider(socketUrl);
